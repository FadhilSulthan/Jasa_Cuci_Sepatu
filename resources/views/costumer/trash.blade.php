...
<div style="margin-top: 20px">
    <div style="margin-bottom: +45px">
        <div style="float:right">
            <a class="btn btn-outline-primary btn-sm" href="{{ route('costumer.index') }}" type="button">Data Customer</a>
...
<div class="form-search" style="float:right">
    <form action="{{ route('costumer.search_trash') }}" method="get" accept-charset="utf-8">
        <div class="form-group" style="display:flex">
            <input type="text" id="Nama_Costumer" name="Nama_Costumer" class="form-control" placeholder="Nama Customer">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="float:right">
                <a href="{{ route('costumer.restore', $data->id_Costumer) }}" type="button"
                    class="btn btn-success rounded-3">Restore</a>
                <!-- TAMBAHKAN KODE DELETE DIBAWAH BARIS INI -->
                <!-- Button trigger modal -->
                <button type="button" class="btn btn-dark" data-bs-toggle="modal"
                    data-bs-target="#hapusModal{{ $data->id_Costumer }}">
                    Hapus
                </button>
                <!-- Modal -->
                <div class="modal fade" id="hapusModal{{ $data->id_Costumer }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('costumer.delete', $data->id_Costumer) }}">
                                @csrf
